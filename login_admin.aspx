<%@ Page Title="" Language="C#" MasterPageFile="~/Restaurant.Master" AutoEventWireup="true" CodeBehind="login_admin.aspx.cs" Inherits="ka.login_admin" %>
...
<div align="center">
    ...
    <table id="tables" style="border:1px solid #ddd; margin-left: auto; margin-right: auto">
        ...
        <tr>
            <td>
                <asp:Label ID="lblPassword" runat="server" Text="كلمةالمرور" 
                    style="font-size: xx-large"></asp:Label>
            </td>
            <td>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<br/>
